...
//          e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        // URL列表数组
        String[] urisToGet = new String[nu];

        for (int i = 0; i < nu; i++) {
            urisToGet[i] = "http://www.500mi.com";
//            urisToGet[i] = "http://www.tuicool.com/articles/NjArYvI";
        }
    ...
    static class GetRunnable implements Runnable {
        ...
        public void run() {
            try {
                System.out.println(HttpClientManager.get(url));
            } finally {
